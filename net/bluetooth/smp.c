...
{
        printf("CVE-2021-0129: Entering function smp_cmd_public_key()\n"); 
	...
	if(test_bit(SMP_FLAG_DEBUG_KEY, &smp->flags)) {
	    printf("CVE-2021-0129: Debug key is in use\n");
	}

	if(crypto_memneq(key, smp->local_pk, 64)){
	    printf("CVE-2021-0129: Remote and local public keys are not identical\n");
	    }
